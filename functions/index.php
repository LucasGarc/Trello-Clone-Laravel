...
try{
    ...
    if (empty($_REQUEST["type"])) { 
        ...
        $result['msg']     = "Falta um parâmetro na requisição";
        ...
        $pdo = new PDO("mysql:host=localhost; dbname=trelo_clone", $username, $password);
        ...
        switch($_REQUEST["type"]){
            ...
            case "update_board":
                ...
                try {
                    ...
                    $result['success'] = false;
                    $result['msg']     = "Erro ao atualizar título";
                    $result['err']     = $e->getMessage();
                }
            ...
            case "delete_board":
                ...
                try {
                    ...
                    $result['success'] = true;
                    $result['msg'] = "Board excluido com sucesso";
                } catch (\PDOException $e) {
                    $result['success'] = false;
                    $result['msg']     = "Erro ao excluir board.";
                    $result['err']     = $e->getMessage();
                }
